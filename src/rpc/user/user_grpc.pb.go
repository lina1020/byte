...
const (
	...
	UserService_GetUserExistInformation_FullMethodName = "/user.UserService/GetUserExistInformation"
)
...
type UserServiceClient interface {
	...
	GetUserExistInformation(ctx context.Context, in *UserExistReq, opts ...grpc.CallOption) (*UserExistResp, error)
}
...
func (c *userServiceClient) GetUserExistInformation(ctx context.Context, in *UserExistReq, opts ...grpc.CallOption) (*UserExistResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(UserExistResp)
...
type UserServiceServer interface {
	...
	GetUserExistInformation(context.Context, *UserExistReq) (*UserExistResp, error)
...
func (UnimplementedUserServiceServer) GetUserExistInformation(context.Context, *UserExistReq) (*UserExistResp, error) {
...
func _UserService_GetUserExistInformation_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).GetUserExistInformation(ctx, req.(*UserExistReq))
	}
	return interceptor(ctx, in, info, handler)
}
